...
from src.utils import save_object_pkl, load_object_pkl
...
class DataTransformationConfig:
    transformed_train_file_path: str = os.path.join(
        os.getcwd(), "artifacts", "transformed_train.npy")
    transformed_test_file_path: str = os.path.join(
        os.getcwd(), "artifacts", "transformed_test.npy")
    preprocessor_object_file_path: str = os.path.join(
        os.getcwd(), "artifacts", "preprocessor.pkl")
...
class DataTransformation:
    ...
    def get_data_tranformer_object(self):
        ...
        try:
            ...
            logging.info("Data transformation object creation completed")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        logging.info("Data transformation started/initiated")
        try:
            train_df = pd.read_csv(train_path)
            test_df = pd.read_csv(test_path)
            logging.info("Train and test data read successfully completed")
            ...
            logging.info(
                f"applying preprocessing object on training and test data {train_df.columns}")
            ...
            logging.info("train and test arrray created successfully")
